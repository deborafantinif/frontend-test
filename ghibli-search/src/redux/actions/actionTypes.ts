...
export const GET_FILMS_BY_FILTERS = "GET_FILMS_BY_FILTERS";
...
export const GET_PEOPLE_BY_FILTERS = "GET_PEOPLE_BY_FILTERS";
export const REQUEST_LOCATIONS = "REQUEST_LOCATIONS";
export const SAVE_LOCATIONS = "SAVE_LOCATIONS";
export const GET_LOCATIONS_BY_NAME = "GET_LOCATIONS_BY_NAME";
export const GET_LOCATIONS_BY_FILTERS = "GET_LOCATIONS_BY_FILTERS";
...
export const GET_SPECIES_BY_FILTERS = "GET_SPECIES_BY_FILTERS";
...
export const GET_VEHICLES_BY_FILTERS = "GET_VEHICLES_BY_FILTERS";
